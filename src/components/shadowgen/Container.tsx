...
const Container = () => {
  const [boxShadow, setBoxShadow] = useState([24, 24, 0, 12, " ", "#00000045"]);
  ...
  const shadowArrayToString = (element: string | number) => {
  ...
  return (
    <>
      <div className='controlPane controls'>
        <Control label="Color" type="color" value={boxShadow[5]} onChangeHandler={(e: any) => onChangeHandler(e, 5)} />
